...
namespace CircularMotionVideoProcessor.Effect
{
    ...
    internal class CircularMotionVideoEffect : VideoEffectBase
    {
        ...
        [Display(Name = "角度の自動調整", Description = "回転に合わせて角度を調整します。")]
        [ToggleSlider]
