...
{
    internal class PosterizationVideoProcessor : IVideoEffectProcessor
    {
        readonly PosterizationVideoEffect item;
        ...
        public PosterizationVideoProcessor(IGraphicsDevicesAndContext devices, PosterizationVideoEffect item)
        {
            this.item = item;
